...
# Always on for Stareha — redaction is a non-negotiable privacy guarantee.
# Can be disabled for debugging via STAREHA_REDACT_DISABLE=1.
_REDACT_ENABLED = os.getenv("STAREHA_REDACT_DISABLE", "").lower() not in ("1", "true", "yes", "on")
...
# Stareha-specific prefix patterns (added before _PREFIX_RE is compiled above)
# These are handled by _ENV_ASSIGN_RE via the _SECRET_ENV_NAMES pattern —
# STAREHA_API_KEY, STAREHA_SECRET, etc. match the existing env-assignment regex.
